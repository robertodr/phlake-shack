# Mirrors upstream home-manager's `programs.pi-coding-agent` (added 2026-06-04),
# which is not yet in `release-26.05`. When home-manager moves to
# `release-26.11`/master, delete this directory — otherwise evaluation fails
# with a duplicate-option error against the upstream module.
{
  config,
  lib,
  pkgs,
