{
  programs.newsboat = {
    ...
    urls = [
      ...
      {
        url = "https://onlinelibrary.wiley.com/action/showFeed?jc=1520636x&type=etoc&feed=rss";
        tags = [];
      }
      {
      ...
      {
        url = "https://onlinelibrary.wiley.com/action/showFeed?jc=17590884&type=etoc&feed=rss";
        tags = [];
      }
      {
        url = "https://onlinelibrary.wiley.com/action/showFeed?jc=1097461x&type=etoc&feed=rss";
        tags = [];
      }
      {
        url = "https://onlinelibrary.wiley.com/action/showFeed?jc=1096987x&type=etoc&feed=rss";
        tags = [];
      }
      {
      ...
      {
        url = "https://www.tandfonline.com/action/showFeed?type=etoc&feed=rss&jc=tmph20";
        tags = [];
      }
      {
